...
class _LanguageTranslatorViewState extends State<LanguageTranslatorView> {
  ...
  final _controller = TextEditingController(); // A text editing controller for controlling the TextField
  final _modelManager = OnDeviceTranslatorModelManager(); // A model manager for managing the models
  var _sourceLanguage = TranslateLanguage.english; // The initial source language 
  var _targetLanguage = TranslateLanguage.spanish; // The initial target language
